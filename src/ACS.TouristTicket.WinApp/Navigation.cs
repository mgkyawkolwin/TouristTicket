...
namespace ACS.TouristTicket.WinApp
{
    public partial class Navigation : Form
    {
         ...
         private void pbSettings_MouseMove(object sender, MouseEventArgs e)
        {
         ...
         void CreateTicketSetting()
         {
             TicketSetting frmTicketSetting = new TicketSetting();
             MdiNavigator.AssignMdiChild(frmTicketSetting);
             MdiNavigator.ShowMdiChild(frmTicketSetting);
         }

         void CreateZoneGroup()
         {
             ZoneGroup frmZoneGroup = new ZoneGroup();
             MdiNavigator.AssignMdiChild(frmZoneGroup);
             MdiNavigator.ShowMdiChild(frmZoneGroup);
         }
         ...
         private void pbZoneGroup_Click(object sender, EventArgs e)
         {
             CreateZoneGroup();
         }

         private void lblZoneGroup_Click(object sender, EventArgs e)
         {
             CreateZoneGroup();
         }

         private void lblTicketSetting_Click(object sender, EventArgs e)
         {
             CreateTicketSetting();
         }

         private void pbTicketAllowance_Click(object sender, EventArgs e)
         {
             CreateTicketSetting();
         }
